...
def make_nums3( x, y):
    ...
    def dec():
        ...
        def decy():
            nonlocal y
            y-=1
        return {'x':decx,'y':decy}
    
    return {'view':view,'add':add,'sub':sub,'inc':inc,'dec':dec}
# ------------------------------------------------
'''
>>> n1=make_nums3(31,4)
>>> n1
{'view': <function make_nums3.<locals>.view at 0x03A3E610>, 'add': <function make_nums3.<locals>.add at 0x03A3E580>, 'sub': <function make_nums3.<locals>.sub at 0x03A3E5C8>, 'inc': <function make_nums3.<locals>.inc at 0x03A3E658>, 'dec': <function make_nums3.<locals>.dec at 0x03A3E6A0>}
>>> n1['view']()  # (31, 4, 0)
>>> n1['add']()   # 35
>>> n1['view']()  # (31, 4, 1)
>>> n1['mul']()
Traceback (most recent call last):
  File "<pyshell#32>", line 1, in <module>
    n1['mul']()
KeyError: 'mul'
>>> n1['inc']     # <function make_nums3.<locals>.inc at 0x03A3E658>
>>> n1['inc']()['y']()
>>> f=n1['inc']()
>>> f
{'x': <function make_nums3.<locals>.inc.<locals>.incx at 0x03A4F658>, 'y': <function make_nums3.<locals>.inc.<locals>.incy at 0x03A4F610>}
>>> f['y']()
>>> n1['dec']()['x']()
>>> n1['sub']()   # 24
>>> n1['view']()  #(30, 6, 2)
